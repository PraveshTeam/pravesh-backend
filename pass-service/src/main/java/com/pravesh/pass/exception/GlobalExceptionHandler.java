...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiErrorResponse> handleValidation(MethodArgumentNotValidException ex,
		...
		return ResponseEntity.badRequest().body(new ApiErrorResponse("Validation failed", errors, req.getRequestURI()));
	}
	...
	public ResponseEntity<ApiErrorResponse> handleInvalidState(InvalidStateException ex, HttpServletRequest req) {
		return ResponseEntity.badRequest().body(new ApiErrorResponse(ex.getMessage(), req.getRequestURI()));
	}
